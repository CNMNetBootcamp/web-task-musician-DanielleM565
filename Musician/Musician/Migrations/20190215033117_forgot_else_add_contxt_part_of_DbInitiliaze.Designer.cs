...
namespace MusicianRecords.Migrations
{
    ...
    [Migration("20190215033117_forgot_else_add_contxt_part_of_DbInitiliaze")]
    partial class forgot_else_add_contxt_part_of_DbInitiliaze
    {
            ...
            modelBuilder.Entity("MusicianRecords.Models.Address", b =>
                {
                    b.HasOne("MusicianRecords.Models.Musician", "Musician")
                        .WithOne("Addresses")
                        .HasForeignKey("MusicianRecords.Models.Address", "MusicianID")
